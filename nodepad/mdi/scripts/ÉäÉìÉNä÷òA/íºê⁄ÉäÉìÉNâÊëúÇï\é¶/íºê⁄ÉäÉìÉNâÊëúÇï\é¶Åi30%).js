...
document.links[i].outerHTML = '<a href="' + j +'target="_brank"><img src="' + j + '" style="zoom:0.3;" alt=\"1\" onerror=\"this.onabort()\" onabort=\"this.alt=eval(this.alt)+1;this.outerHTML=this.outerHTML\"></a>'; 
} 
//引用元：スクリプト転載スレ